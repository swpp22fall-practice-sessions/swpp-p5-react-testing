...
jest.mock("../../components/Todo/Todo", () => (props: TodoProps) => (
    <div data-testid="spyTodo">
        <div className="title" onClick={props.clickDetail}>{props.title}
    </div>
    <button className="doneButton" onClick={props.clickDone}>done
    </button>
...
jest.mock("react-redux", () => ({
    ...jest.requireActual("react-redux"), //원래있던 것 냅두기 위해서(?)
