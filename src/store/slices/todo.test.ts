...
import { fetchTodo, fetchTodos, postTodo, deleteTodo, toggleDone } from "./todo";

describe("todo reducer", () => {
    let store: EnhancedStore<{todo: TodoState}, AnyAction, [ThunkMiddleware<{todo: TodoState}, AnyAction, undefined>]>;
    const fakeTodo = { id: 1, title: "test", content: "test", done: false};
    ...
    it("should handle fetchTodo", async () => {
        ...
        expect(store.getState().todo.selectedTodo).toEqual([fakeTodo]);    //TODO [fakeTodo] -> fakeTodo why???
    });
